...
from shellspark.core.config import (
    VERSION,
    GROQ_MODEL,
    CONFIG_FILE,
    HISTORY_FILE,
...
from shellspark.core.system import get_distro_info, get_package_manager, get_shell
from shellspark.engine.history import append_history, clear_history, show_history
from shellspark.cli.chat import detect_conversational
from shellspark.engine.ai import generate_command, explain_command
from shellspark.engine.safety import classify
from shellspark.engine.intent import (
    classify_intent,
    resolve_install_command,
    IntentType,
)
from shellspark.cli.executor import confirm_and_run
from shellspark.cli.explainer import explain_last_or_query
from shellspark.core.logger import log_event
from shellspark.engine.navigator import is_navigation_query, resolve_navigation_command
from shellspark.cli.ui import (
    console,
    print_command,
    print_safety_status,
    print_error,
